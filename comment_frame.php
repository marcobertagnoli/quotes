...
<body>
	...
	<script>
		...
		function toggle() {
			...
			// if it's showing then hide it, otherwise if its hidden then show it!
	...
	<?php  
	//Get id of post: check if those IDs are variables
	// GET variables are sent as a parameter through pages ( within the link)
	...
	<!-- HANDLER FOR THE POST FORM, to put it into the database -->
	<!-- IN THE LINK I attach the ID of the comment I am linked to -->
	...
	<div class ='comment_section'>
		<!-- In this way I load the page linked outside the box of the comment -->
		<a href="<?php echo $posted_by?>" target="_parent"><img src="<?php echo $user_obj->getProfilePic();?>" title="<?php echo $posted_by; ?>" style="float:left;" height="30"></a>
